...
@Abcd
Scenario: Verify the info button functionality for Map Item
...
@Abcd
Scenario: To verify the new item Newspaper Article creation and entering data's
...
@Abcd
Scenario: Verify the info button functionality for Newspaper Article Item
...
@Abcd
Scenario: Verify the info button functionality for Patent Item
...
@Abcd
Scenario: To verify the new item Podcast creation and entering data's
    Given I click on the Podcast
    When I enter the data for the Item Podcast 
    Then I verify the created Item Podcast
@Abcd
Scenario: Verify the info button functionality for Podcast Item
...
@Abcd
Scenario: To verify the new item Preprint creation and entering data's    
    Given I click on the Preprint
    When I enter the Test Data for the item preprint
    Then I verify the created Item Preprint
@Abcd
Scenario: Verify the info button functionality for Preprint Item
...
@Abcd
Scenario: To verify the new item TV Broadcast creation and entering data's 
...
@Abcd
Scenario: Verify the info button functionality for TV Broadcast Item
...
@Abcd
Scenario: To verify the new item Video Recording creation and entering data's 
...
@Abcd
Scenario: Verify the info button functionality for Video Recording Item
...
@Abcd
Scenario: To verify the new item Radio Broadcast creation and entering data's 
...
@Abcd
Scenario: Verify the info button functionality for Radio Broadcast Item
...
@Abcd
Scenario: To verify the new item Software creation and entering data's 
    Given I click on the Software
    When I enter the data for the Item Software
    Then I verify the created Item Software
@Abcd
Scenario: Verify the info button functionality for Software Item
...
@Abcd
Scenario: To verify the new item Statue creation and entering data's 
    Given I on click the Statute
    When I enter the data for the Item Statute 
    Then I verify the created Item Statute
@Abcd
Scenario: Verify the info button functionality for Statue Item
...
@Abcd
Scenario: To verify the new item Presentation creation and entering data's  
    Given I click on the Presentation
    When I enter Data for the item Presentation
    Then I verify created Item for Presentation
@Abcd
Scenario: Verify the info button functionality for Presentation Item
...
@Abcd
Scenario: To verify the new item Thesis creation and entering data's  
    Given I click on the Thesis
    When I enter Data for the item Thesis
    Then I verify created Item for Thesis
@Abcd
Scenario: Verify the info button functionality for Thesis Item
